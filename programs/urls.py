...
urlpatterns = [
    ...
    url(r'^programs/(?P<id>\d+)/$', ProgramDetailView.as_view(), name='api.programs.detail'),
    url(r'^programs/search/$', ProgramSearchView.as_view(), name='api.programs.search'),
    ...
    url(r'^colleges/search/$', CollegeSearchView.as_view(), name='api.colleges.search'),
    ...
    url(r'^departments/search/$', DepartmentSearchView.as_view(), name='api.departments.search')
]
